...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 25 22:52:11 2020
...
#pivot_df.to_csv ('rda/AllCumulativeCounts1.csv', header=True)
#pivot_df.to_csv ('rda/FilteredCumulativeCounts1.csv', header=True)
pivot_df.to_csv ('rda/AwardTotal1.csv', header=True)
...
#filename = 'figs/AllCumulativeCounts1.png'
#filename = 'figs/FilteredCumulativeCounts1.png'
filename = 'figs/FilteredAwardCumulativeValue1.png'
