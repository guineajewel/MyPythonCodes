...
Additional filters applied 
    solicitation_procedures_code = 'NP' and modification_number ='0'
    
2. Write to '_forhistogram2.csv' for each agency for award value histogram analysis
 3. Write to '_forhistogrambyyear2.csv' for each agency for award value histogram analysis
    group by per year
...
try:
    ...
    #34
        ...
        df1.to_csv ('data/'+agency_abb[m]+'_forhistogram2.csv', header=True)    
        print('data/'+agency_abb[m]+'_forhistogram2.csv')
#35
        df2 = pd.read_sql_query(sqst.sqlst35.format(agency_abb[m]), engine)
        df2.to_csv ('data/'+agency_abb[m]+'_forhistogrambyyear2.csv', header=True)    
 ...
 #30
    ...
    #31
        ...
        df1.to_csv ('data/'+agency_abb[m]+'_Top15Vendors2.csv', header=True)

        table_name = 'data/'+agency_abb[m]+"_Top15Vendors2_detail"
        print(table_name)    
        #x=0
