...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 25 22:49:25 2020
...
used allagency1 table from the database and SQL17 statement from the sqlstmnts.py file
...
for m in range(len(agency_abb)):
    ...
    time.sleep(1)
    plt.savefig('figs/'+agency_abb[m]+'awardcount2009to2019-1.png', dpi=300)
    plt.show()
    ...
    df.to_csv ('rda/'+agency_abb[m]+'awardcount2009to2019-1.csv', header=True)